ActiveAdmin.register_page 'Indonesia Platform Funding' do
  ...
  controller do
    ...
    def s3_folder_path
      "#{CW_FILES_PREFIX}funding"
    end

    def path
      admin_indonesia_platform_funding_path
    end
    ...
    def import_worker
      DataUploader::BaseImportWorker.perform_async(section.id, 'ImportFundingOpportunities', current_admin_user.email)
    end
  ...
  content do
    render partial: 'data_uploader/admin/form_upload_datasets', locals: {
      ...
      upload_path: admin_indonesia_platform_funding_upload_datafile_path,
      download_path: admin_indonesia_platform_funding_download_datafiles_path,
      download_single_data_file_path:
          admin_indonesia_platform_funding_download_datafile_path,
      import_path: admin_indonesia_platform_funding_run_importer_path,
