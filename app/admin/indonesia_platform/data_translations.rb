ActiveAdmin.register_page 'Indonesia Platform Data Translations' do
  include DataUploader::SharedAdmin

  section_name = 'data_translations'
  ...
  controller do
    ...
    def s3_folder_path
      "#{CW_FILES_PREFIX}data_translations"
    end

    def path
      admin_indonesia_platform_data_translations_path
    end
    ...
    def import_worker
      DataUploader::BaseImportWorker.perform_async(section.id, 'ImportDataTranslations', current_admin_user.email)
    end
  ...
  content do
    render partial: 'data_uploader/admin/form_upload_datasets', locals: {
      ...
      upload_path: admin_indonesia_platform_data_translations_upload_datafile_path,
      download_path: admin_indonesia_platform_data_translations_download_datafiles_path,
      download_single_data_file_path:
          admin_indonesia_platform_data_translations_download_datafile_path,
      import_path: admin_indonesia_platform_data_translations_run_importer_path,
