ActiveAdmin.register_page 'Indonesia Platform Historical Emissions' do
  ...
  controller do
    ...
    def path
      admin_indonesia_platform_historical_emissions_path
    end
  ...
  content do
    render partial: 'data_uploader/admin/form_upload_datasets', locals: {
      ...
      upload_path: admin_indonesia_platform_historical_emissions_upload_datafile_path,
      download_path: admin_indonesia_platform_historical_emissions_download_datafiles_path,
      download_single_data_file_path:
          admin_indonesia_platform_historical_emissions_download_datafile_path,
      import_path: admin_indonesia_platform_historical_emissions_run_importer_path,
