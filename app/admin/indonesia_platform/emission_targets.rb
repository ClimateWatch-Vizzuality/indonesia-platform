ActiveAdmin.register_page 'Indonesia Platform Emission Targets' do
  include DataUploader::SharedAdmin

  section_name = 'emission_targets'
  ...
  controller do
    ...
    def s3_folder_path
      "#{CW_FILES_PREFIX}emission_targets"
    end

    def path
      admin_indonesia_platform_emission_targets_path
    end
  ...
  content do
    render partial: 'data_uploader/admin/form_upload_datasets', locals: {
      ...
      upload_path: admin_indonesia_platform_emission_targets_upload_datafile_path,
      download_path: admin_indonesia_platform_emission_targets_download_datafiles_path,
      download_single_data_file_path:
          admin_indonesia_platform_emission_targets_download_datafile_path,
      import_path: admin_indonesia_platform_emission_targets_run_importer_path,
