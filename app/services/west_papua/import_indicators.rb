class WestPapua::ImportIndicators
  ...
  INDICATORS_FILEPATH = "#{CW_FILES_PREFIX}indicators/wp_indicators.csv".freeze
  INDICATORS_ID_FILEPATH = "#{CW_FILES_PREFIX}indicators/wp_indicators_id.csv".freeze
  INDICATOR_VALUE_FILEPATHS = %W(
    #{CW_FILES_PREFIX}indicators/wp_population.csv
    #{CW_FILES_PREFIX}indicators/wp_economic.csv
    #{CW_FILES_PREFIX}indicators/wp_social.csv
  ).freeze
